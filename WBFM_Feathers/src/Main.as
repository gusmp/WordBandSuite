package
{
	...
	import org.gusmp.config.AppConfig;
	...
	public class Main extends Sprite
	{
		...
		public static var appContext:Context;
		...
		public function Main()
		{
			...
			// robotlegs
			Main.appContext = new Context();
			Main.appContext.install(MVCSBundle);
			Main.appContext.configure(AppConfig);
			Main.appContext.configure(new ContextView(this));
		}
		...
		private function showLaunchImage():void
		{
			...
			/*
			if(Capabilities.manufacturer.indexOf("Win") >= 0)
			{
				filePath = "splash.png";
			}
			
			if(Capabilities.manufacturer.indexOf("AND") >= 0)
			{
				filePath = "splash.png";
			}
			*/
		...
		private function loaderInfo_completeHandler(event:Event):void
		{
			...
			this._starling = new Starling(MainView, this.stage, null, null, Context3DRenderMode.AUTO, Context3DProfile.BASELINE);
